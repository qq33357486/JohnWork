	...
	public class BindUnity {
		public static Action<IntPtr>[] GetBindList() {
			Action<IntPtr>[] list= {
				...
				Lua_UnityEngine_EventProvider.reg,
				...
				Lua_UnityEngine_WSA_WindowActivationState.reg,
				Lua_UnityEngine_WSA_Application.reg,
				Lua_UnityEngine_WSA_TileTemplate.reg,
				Lua_UnityEngine_WSA_ToastTemplate.reg,
				Lua_UnityEngine_WSA_TileForegroundText.reg,
				Lua_UnityEngine_WSA_SecondaryTileData.reg,
				Lua_UnityEngine_WSA_Tile.reg,
				Lua_UnityEngine_WSA_Toast.reg,
				Lua_UnityEngine_WSA_Folder.reg,
				Lua_UnityEngine_WSA_Launcher.reg,
